...
- Use production environment variables in both services
- Add deployed links below before submission
...
- [ ] Live frontend link
- [ ] Live backend link
- [ ] Updated README with final setup and workflow
- [ ] Screenshots of major modules
- [ ] Postman collection or API testing evidence
